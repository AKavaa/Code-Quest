...
function getDifficulty() {
    ...
    if (path.includes('select_beginner')) return 'beginner';
    if (path.includes('select_intermediate')) return 'intermediate';
    if (path.includes('select_advanced')) return 'advanced';
...
function loadQuestionsFromJSON() {
    console.log("Fetching questions from:", KNOWLEDGE_Q); // DEBUG
...
function loadQuestionsForDifficulty() {
    ...
    currentQuestions = locked_questions.general_knowledge_questions.filter(q => q.level === difficulty);
